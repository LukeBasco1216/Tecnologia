...
export class SpotifyService {
  ...
  searchTrack(query: string) {
    ...
    const headers = new HttpHeaders({
      Authorization:
        'Bearer BQBGBxPywVV7FWj8MVfCiCJs3wAteE7PiXVQRY-NG891ihCNhz2BA4NM2Hwl0rJ-Cqei8g0FE11U7cr2L4iw8cB-nMAo-DWh_EQtQedu0Nrz3ve29sx8qQtxQiUfOPkinpML5v9msLmX1OKfZxUSyrtaXua-MKJcdl2UtWJxuJLln34GILEmP_G6mLuSpsGkY-28'
    });
